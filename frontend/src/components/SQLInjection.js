...
import { Button, TextField, Box, Typography, Switch, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper } from "@mui/material";
    ...
    return (
        <Box sx={{ maxWidth: 500, mx: "auto", mt: 5 }}>
            ...
            <Box display="flex" alignItems="center" sx={{ mb: 2 }}>
                <Typography variant="body1" sx={{ mr: 2 }}>Vulnerable</Typography>
                <Switch
                    checked={!useVulnerableEndpoint}
                    onChange={() => setUseVulnerableEndpoint(!useVulnerableEndpoint)}
                    color="primary"
                />
                <Typography variant="body1" sx={{ ml: 2 }}>Secure</Typography>
            </Box>
